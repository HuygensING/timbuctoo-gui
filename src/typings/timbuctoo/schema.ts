...
export interface Jauco_Leaders_Leader {
  ...
  schema_org_description: string | null;
  schema_org_birthPlace: string | null;
  schema_org_imageUrl: string | null;
}
