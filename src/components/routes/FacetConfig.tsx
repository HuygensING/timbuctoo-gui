...
const FacetConfig: SFC<GraphProps> = props => {
    const onSubmit = async () => {
        ...
        try {
            ...
            await props.mutate!({ variables: { dataSetId: dataSetId, collectionUri: collection!.uri, indexConfig } });
...
const submitFacetConfig = () => gql`
    mutation submitFacetConfig($dataSetId: String!, $collectionUri: String!, $indexConfig: IndexConfigInput!) {
