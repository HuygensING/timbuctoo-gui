...
import { EsMatch, EsMatches, EsRange, EsRangeProps } from '../services/EsQueryStringCreator';
...
const findRangeIndexes = (values: EsValue[], range: EsRangeProps): EsRangeIndexProps => {
    const obj = {
        lt: values.length - 1,
        gt: 0,
        all: values.length < 2
