...
export const GRAPH_URI = REACT_APP_API_URL ? REACT_APP_API_URL : 'http://localhost:8080/v5/';
export const LOGIN_URL = `${REACT_APP_LOGIN_URL ? REACT_APP_LOGIN_URL : 'http://example.com'}`;
