...
const translation: languageType = {
    ...
    'search.from': 'vanaf',
    'search.to': 't/m',
    'upload.heading': 'Sleep bestanden hierheen om te uploaden naar de collectie',
    'upload.body': 'Ondersteunde bestandsformaten:',
    'upload.rejected': 'Ongeldig bestandsformaat',
