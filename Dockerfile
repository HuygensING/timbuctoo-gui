...
CMD sh -c 'echo "window.dynamicEnv = {REACT_APP_HIDE_OWN_DATASETS: '"'"'$REACT_APP_HIDE_OWN_DATASETS'"'"', REACT_APP_PRIMARY_COLOR: '"'"'$REACT_APP_PRIMARY_COLOR'"'"', REACT_APP_TEXT_EN_TITLE: '"'"'$REACT_APP_TEXT_EN_TITLE'"'"', REACT_APP_TEXT_EN_LEADER_TEXT: '"'"'$REACT_APP_TEXT_EN_LEADER_TEXT'"'"', REACT_APP_TEXT_NL_TITLE: '"'"'$REACT_APP_TEXT_NL_TITLE'"'"', REACT_APP_TEXT_NL_LEADER_TEXT: '"'"'$REACT_APP_TEXT_NL_LEADER_TEXT'"'"', REACT_APP_DEFAULT_HERO_IMAGE: '"'"'$REACT_APP_DEFAULT_HERO_IMAGE'"'"', REACT_APP_LOGO_URL: '"'"'$REACT_APP_LOGO_URL'"'"', REACT_APP_TEXT_EN_APP_TITLE: '"'"'$REACT_APP_TEXT_EN_APP_TITLE'"'"', REACT_APP_TEXT_NL_APP_TITLE: '"'"'$REACT_APP_TEXT_NL_APP_TITLE'"'"', REACT_APP_API_URL: '"'"'$REACT_APP_API_URL'"'"', REACT_APP_LOGIN_URL: '"'"'$REACT_APP_LOGIN_URL'"'"'};" > dynamic_env.js && serve -s -p 80'
