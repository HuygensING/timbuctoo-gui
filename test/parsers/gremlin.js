...
g.V()
    ...
    .or(__.and(or(has("wwperson_gender")
                .where(__.values("wwperson_gender")
                    .is("\\"FEMALE\\"")), has("wwperson_gender")
                .where(__.values("wwperson_gender")
                    .is("\\"MALE\\""))), has("wwperson_types")
            .where(__.values("wwperson_types")
                .is("\\"AUTHOR\\"")))
        .and(__.bothE("isCreatedBy")
            .otherV()
            .as("or|0|and|2|or")
            .or(__.and(__.bothE("isCreatedBy")
                    .otherV()
                    .as("or|0|and|2|or|0|and|0|or")
                    .or(__.has("wwperson_gender")
                        .where(__.values("wwperson_gender")
                            .is("\\"MALE\\"")))
                    .union(__()
                        .as("or|0|and|2|or|0|and|0|or|0")
                        .has("wwperson_gender")
                        .where(__.values("wwperson_gender")
                            .is("\\"MALE\\""))))
                .union(__.bothE("isCreatedBy")
                    .as("or|0|and|2|or|0|and|0")
                    .otherV()
                    .as("or|0|and|2|or|0|and|0|or")
                    .or(__.has("wwperson_gender")
                        .where(__.values("wwperson_gender")
